                ...
                <footer className="flex lg:flex-row md:flex-row flex-col text-base-content lg:justify-between md:justify-between justify-center gap-4 lg:px-28 py-6">
                    <aside className='flex flex-col justify-center items-center gap-3 lg:text-left text-center'>
                        <div className='flex flex-col justify-center items-center gap-3'>
                            ...
                            <p className='max-w-[350px] dark:text-black'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Veritatis, aut obcaecati nam voluptatum nesciunt exercitationem.</p>
                            <div className=''>
                                <button className='btn btn-outline btn-sm text-[#0645B1] w-32'>Join</button>
                            </div>
                        </div>
                    </aside>
