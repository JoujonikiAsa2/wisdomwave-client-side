                    ...
                    filteredTuitions.length > 0 ? filteredTuitions.map(tuition => 
                        <div class="tuition-card text-sm w-[90%] md:w-[40vw] lg:w-[28vw] h-[320px] lg:h-[310px]">
                            ...
                            <div className='flex justify-center'>
                                <button className='btn btn-sm border shadow-2xl bg-transparent rounded-3xl border-[#29ADB2] hover-[#29ADB2]  hover:bg-gradient-to-t hover:from-[#0766AD] hover:to-[#29ADB2] hover:text-white text-black w-1/4 focus:outline-none capitalize font-thin' onClick={() => {document.getElementById('my_modal_3').showModal()
