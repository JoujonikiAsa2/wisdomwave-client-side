...
const CourseDashboard = () => {
    ...
    // console.log("courses for manage", course)
    // 
        ...
        axiosPublic.patch(`/api/student/rating/${id}`, ratingInfo)
            .then(res => {
                ...
                if (res.data.status === "success") {
                    toast.success('Rated the course successfully');
                    refetch();
                }
    ...
    return (
        <>
            ...
            {
                course === null ?
                    <div className='lg:pt-20 md:pt-20 pt-20 flex justify-center items-center h-screen'>
                        ...
                        <div className='py-6 text-[#29ADB2]'>
                            {filteredDate?.length !== 0 && filteredDate?.length > 0 ? <Marquee><p className='text-lg'>You have a class today</p></Marquee> : null}
                        </div>
