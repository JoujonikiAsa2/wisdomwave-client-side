...
const Banner = ({ slider, sliderText, subText }) => {
    return (
        <div className="h-[450px] md:wh-[70vh] lg:h-[70vh] 2xl:h-[60vh] w-full lg:pt-20 pt-28 flex lg:flex-row md:flex-row flex-col-reverse justify-center items-center bg-[#CEE7E1] lg:gap-20 md:gap-20 pb-10">
