...
const ManageTuitions = () => {
    ...
    const localHandleSearch = (e) => {
        ...
        axiosPublic.get(`/api/tuitions/email/${searchString}`)
            .then(res => {
                // console.log(res.data.data)
                setTuitions(res.data.data)
            })
    ...
    return (
        <div className='z-10'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pb-8'>
                {tuitions.map(tuition => <div class="relative tuition-card text-sm w-[90%] md:w-[40vw] lg:w-[28vw] h-[320px] lg:h-[310px]">
                    ...
                    <div className=' absolute -right-4 top-14 h-16 w-8 justify-center items-center flex flex-col gap-1 bg-slate-300 rounded-xl'>
                        <div className="lg:tooltip" data-tip="Delete" onClick={() => handeDelete(tuition?.tuitionCode)}>
                        ...
                        <div className="lg:tooltip" data-tip="Edit" onClick={() => {document.getElementById('my_modal_4').showModal()
