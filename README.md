...
### **Instructor**  
📧 **Email:** joujoniki15-13928@diu.edu.bd  
🔑 **Password:** `wisdomwaveinstructor`  
...
```bash
git clone https://github.com/JoujonikiAsa2/wisdomwave-client-side
```

2. Move to the cloned directory

```bash
cd wisdomwave-client-side
```
...
VITE_IMAGE_HOSTINF_API=************
VITE_YOUR_API_KEY=************
VITE_EMAILJSSERVICEID=************
